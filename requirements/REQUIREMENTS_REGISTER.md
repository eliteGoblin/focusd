...
*Last updated: 2026-06-19 (release-review: F14 shipped PR #60 [§4 row + §9 + spec + ADR-0018 status, honest live-vs-unit verification split]; corrected stale §9/§8 ADR-0015 fetch-storm row → RESOLVED PR #54; #38 build-rebundle → RESOLVED PR #44 [§7+§9]). Maintainer: Frank Sun + Claude (joint).*
