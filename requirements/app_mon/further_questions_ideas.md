...
* Let user select device management: if quite addicted, need harsh method=> MDM. Otherwise, need just block(self won't remove). So need some questionare to help user decide. give recommenddation, but still let user choose
* Cannot be perfect, seems corp user won't be much justify ROI
